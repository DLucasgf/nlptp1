...
model1 = gensim.models.KeyedVectors.load_word2vec_format('/home/lucas/Documentos/git/nlptp1/outs/' + docs[0], binary=False)
#model2 = gensim.models.KeyedVectors.load_word2vec_format('/home/lucas/Documentos/git/nlptp1/outs/' + docs[], binary=False)
#model3 = gensim.models.KeyedVectors.load_word2vec_format('/home/lucas/Documentos/git/nlptp1/outs/' + docs[], binary=False)
