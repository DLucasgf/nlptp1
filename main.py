...
'Jane Eyre- An Autobiography by Charlotte Brontë.txt',
...
sentences = MySentences('/home/lucas/Documents/git/nlptp1/docs', 'Candide by Voltaire.txt') # a memory-friendly iterator
